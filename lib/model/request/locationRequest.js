var LocationRequest = function LocationRequest(name, state, country, street, city, zip, openingTimes, coordinates) {
  this.name = name;
  this.state = state;
...
var LocationRequestBuilder = function LocationRequestBuilder() {
  this.name = null;
  this.state = null;
  this.country = null;
  this.street = null;
